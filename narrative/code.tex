...
\caption{\label{fig:sdf-best-case}Performance benefit of \gls{SDF} in an ideal
  ...
  sphere.\citeref{shriwise_particle_2017}}
\end{wrapfigure}
...
low.\citeref{shriwise_particle_2017}
...
\caption{\label{fig:gt-cadis-timing}Performance benefit of \gls{GT-CADIS}
  compared to \gls{FW-CADIS} and analog simulation.\citeref{biondo_transmutation_2017}}
\end{wrapfigure}
